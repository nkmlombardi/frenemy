...
Game.prototype.startGame = function() {
    ...
    setInterval(_.bind(function() {
        ...
        global.io.in(this.id).emit('updateChat', 'Server', 'Round has begun!');
        global.io.in(this.id).emit('updateChat', 'Server', 'Remaining Players: ' + players.map(function(item) { return item.name }).join(', '));
